...
let sharp: object | undefined;
const errors: Error[] = [];

const sharpNative = { exports: {} };
const pathSharp = `node_modules/@img/sharp-${runtimePlatform}/lib/sharp-${runtimePlatform}.node`;

process.dlopen(
  sharpNative,
  path.join(process.cwd(), pathSharp),
